...
global_interpretation unat_rbt: rbt_impl
  ...
  defines 
    ...
    unat_rbt_delete = unat_rbt.delete
...
abbreviation unat_rbt_delete_64 :: "_ \<Rightarrow> (64 word, 8 word) rbti \<Rightarrow> _"
  where "unat_rbt_delete_64 \<equiv> unat_rbt_delete"
...
export_llvm
  ...
  unat_rbt_delete_64 is "rbt_node* rbt_delete(uint64_t, rbt_node*)"
  defines \<open>
    typedef struct {
       uint8_t color;
       rbt_node* lhs;
